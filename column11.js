class VoltonEidiko_class {
    constructor() {
        ...
        this.programmaLink = "https://volton.gr/eidiko/";
        this.alfa = 1.399;
    ...
    get MinSunMeDor() {        
        //=SUM(L20:L25)-1,065*(L16+IF(B19+D19>500; 500*L12; (B19+D19)*L12))
        //=D12=this.TTim1 $B19=MinKatIm D14=this.TTnu $D19=MinKatNu D16=this.pagio
        let a = this.HrePro + this.RuthmHre + this.EFK + this.DETE + this.FPA + this.ERT;
        let b=1.065*(this.pagio+(MinKatIm+MinKatNu>500 ? 500*this.TTim1 : (MinKatIm+MinKatNu)*this.TTim1));
        return(a-b);
    }
}