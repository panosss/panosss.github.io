class VolterraEidiko_class {
    constructor() {
        this.setColumn(3);
        this.table= tables[(this.column)];
        this.color="green";
        this.parohos = "Volterra";
        this.programmaName = "Ειδικό";
        this.programmaLink = "https://www.volterra.gr/forward-%CE%B3%CE%B9%CE%B1-%CF%84%CE%BF-%CF%83%CF%80%CE%AF%CF%84%CE%B9-%CF%81%CE%B5%CF%8D%CE%BC%CE%B1/eidiko-timologio-gia-to-spiti/";
        this.alfa = 1.25;
