class ElinPOHG_class {
    constructor() {
        this.setColumn(3);
        this.table = tables[(this.column)];
        this.color = "green";
        this.parohos = "ελίν";
        this.programmaName = "Power On! Home Green";
        this.programmaLink = "https://energy.elin.gr/ilektriki-energeia-new/gia-to-spiti-ilektriko-reyma-on/power-on-home-green-reuma/";
        this.alfa = 1.22;
        ...
        this.ERT = 2.96;
        this.tt2 = '<div class="right"><h3>Η Τελική τιμή ημέρας 0-500 kWh/μήνα <br> προκύπτει ως εξής:</h3>\n' +
            '<p>Βασική τιμή ημέρας 0-500 kWh/μήνα ④ <br>+ Μηχανισμός διακύμανσης③</p>\n' +
            '<i></i></div></div>';

        this.tt3 = '<div class="right"><h3>Η Τελική τιμή νύχτας<br> προκύπτει ως εξής:</h3>\n' +
            '<p>Βασική τιμή νύχτας ⑤ <br>+ Μηχανισμός διακύμανσης③</p>\n' +
            '<i></i></div></div>';

        this.tt4 = '<div class="right"><h3>Τελική τιμή νύχτας<br> προκύπτει ως εξής:</h3>\n' +
            '<p>στο ④ προσθέτουμε το ①</p>\n' +
            '<p>δηλαδή στην Βασική τιμή νύχτας ④ <br>προσθέτουμε τον Μηχανισμό Διακύμανσης①</p><i></i></div></div>';
        ...
        this.print = function () {
            ...
            //alert("ElinPOHG_class color=" + this.table.rows[1].cells[1].currentStyle);

            /* const element = this.table.rows[1].cells[1];
            console.log("element=", element.style); */

            // set two heading cells color
            this.table.rows[0].cells[1].style.backgroundColor = this.color;
            this.table.rows[1].cells[1].style.backgroundColor = this.color;
