class OTE_ESTATE_eidiko_class {
    constructor() {
        this.setColumn(15);
        this.table= tables[(this.column)];
        this.color="green";
        this.parohos = "OTE ESTATE";
        this.programmaName = "Ειδικό";
        this.programmaLink = "https://ote-estate.gr/energy/el-gr/%CE%A0%CE%A1%CE%9F%CE%AA%CE%9F%CE%9D%CE%A4%CE%91/%CE%93%CE%99%CE%91-%CE%A4%CE%9F-%CE%A3%CE%A0%CE%99%CE%A4%CE%99";
        this.alfa = 1.145;
