class ElpedisonEidiko_class {
    constructor() {        
        this.setColumn(8);
        this.table= tables[(this.column)];
        this.color="green";
        this.parohos = "ELPEDISON";
        this.programmaName = "Ειδικό";
        this.programmaLink = "https://www.heron.gr/energy/electricity/gia-to-spiti/basic-home/";
        this.alfa = 1.3115;
    ...
    get MinSunMeDor() {
        return (this.HrePro + this.RuthmHre + this.EFK + this.DETE + this.FPA + this.ERT)-60;
    }
}